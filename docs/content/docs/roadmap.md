...
in the current line. The verified browser fixture replication and minimization directories plus proxy replication directories and standalone redacted trace documents now participate in that common validation surface; emulator evidence, wider artifact-family mapping, and
