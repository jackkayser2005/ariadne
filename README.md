...
history itself. It returns only the bounded result and 1-based transition
indexes for changed or membership-incomparable boundaries; it does not infer
chronology or prove the underlying evidence.
